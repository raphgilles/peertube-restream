...
<html lang='fr'>
<head>
	<title>Twitch live > PeerTube</title>
...
if(empty($pids)) { ?>
   ...
   <h1 style="text-align:center; margin-bottom:100px; margin-top:100px;">Restreamer un live Twitch sur PeerTube</h1>
...
<h3 style="text-align:left; font-family:robotolight; margin-top:25px;">Url du live Twitch</h3>
...
<li>Le live doit être déjà lancé sur Twitch avant d'appuyer sur le bouton ci-dessous.</li>
</ul>
</div>
...
<div style="margin-top:50px; text-align:center; padding-bottom:75px;"">
